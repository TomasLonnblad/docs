...
## Upgrading from version 4 to version 5.9.0 or later

Upgrades from PGD 4 to PGD 5.9.0 or later are supported from version 4.4.0.
For earlier versions, upgrade to 4.4.0 before upgrading to 5.9.0 or later
...
4.4.0 or later, the following upgrade paths are possible.
